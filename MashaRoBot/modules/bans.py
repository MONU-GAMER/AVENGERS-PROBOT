...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            message.reply_text("Trying to put me against a God level disaster huh? Bhosdi mere bot master ko ban mat kr 😠 BC 😠")
        elif user_id in DEV_USERS:
            message.reply_text("I can't act against our own 😠 BC 😠")
            ...
            message.reply_text(
                "Bring an order from Heroes association to fight a Tiger disaster 😠 mere family member ko ban mat kr 😠 BC 😠"
            )
